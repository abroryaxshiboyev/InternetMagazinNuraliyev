...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $shopManager->syncPermissions($shopManagerPermissions,$helpDeskPermissions);
        // $shopManager->syncPermissions($helpDeskPermissions);
        $shopManager->givePermissionTo($statsPermission);
    }
}
